...
<input id=" + t1 + "d_dd name=" + t1 + "d_dd class=d autocomplete=off size=1 maxlength=2 value=\"\"\ onkeypress=\"javascript:return oKPdd(event,'" + t1 + "d','_dd','_pl');\" onkeydown=\"javascript:return oKD1(event,'" + t1 + "d_dd','" + t1 + "d_mm');\"/>"
  ...
  function addPvar(z1,z2)
  {
    ...
    ><\/td><td><input id="' + t1 + '_fn" name="p' + c1 + '" class="ar" size="20" maxlength="200" value="" onblur="tUC1(this)"\n\
    ><\/td><td><input id="' + t1 + '_sn" name="n' + c1 + '" size="20" maxlength="200" value="" onblur="tUC(this);jq1(\''+ t1 +'\',\'\')"\n\
    ...
    ><\/td><td><input id="' + t1 + '_t" name="t' + c1 + '" size="20" maxlength="200" value=""\n\
